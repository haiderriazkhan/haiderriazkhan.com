...
export const projects = [
  {
    title: "Red Calendar",
    role: "Co-Director and Lead Developer",
    url: "https://cal.red/",
    image: "/images/red-cal.png",
    description:
      "A NYC-based arts and action calendar managed by a team of editors and open to community submissions."
  },
  {
    title: "CANDLE-J",
    role: "Developer",
    url: "https://github.com/haiderriazkhan/CANDLE-J",
    image: "/images/hooke-sketch.png",
    description:
      "3D image denoising software for ImageJ, designed for deep in vivo multiphoton microscopy images with low signal-to-noise ratios."
  }
];
